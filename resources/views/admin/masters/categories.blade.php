                ...
                <form class="form-horizontal form-bordered" method="post" id="editForm">
                    ...
                    <section class="card">
                        ...
                        <div class="card-body py-2">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    <label class="col-form-label" for="edit_name">category Name <span class="text-danger">*</span></label>
                                    <input class="form-control" id="edit_name" name="edit_name" type="text" placeholder="category Name">
                                    ...
                                    @foreach ($categorys as $category)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-dark rem-element px-2 py-1" title="Delete category" data-id="{{ $category->id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    ...
                    $("#editForm input[name='edit_name']").val(data.category.name);
                }
                else
                {
                    alert(data.error);
